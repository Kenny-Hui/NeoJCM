...
public class RVPIDSRenderer extends PIDSRenderer<RVPIDSBlockEntity> {
    ...
    @Override
    public void renderPIDS(RVPIDSBlockEntity blockEntity, PIDSPresetBase pidsPreset, PoseStack poseStack, MultiBufferSource bufferSource, Level world, BlockState state, BlockPos pos, Direction facing, List<ScheduleEntry> arrivals, float tickDelta, boolean[] rowHidden) {
